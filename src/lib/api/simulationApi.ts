  ...
  return {
    ...
    strategies: (raw.strategies || []).map((s: RawBacktestStrategy) => ({
      ...
      transactionImpact: {
        ...
        costPerLakh: s.transaction_impact?.cost_per_denom ?? s.transaction_impact?.cost_per_lakh ?? 0,
        costPerDenom: s.transaction_impact?.cost_per_denom ?? s.transaction_impact?.cost_per_lakh ?? 0,

...
function VerifyOTPPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VerifyOTPPage.useEffect": ()=>{
            ...
            const t = setInterval({
                "VerifyOTPPage.useEffect.t": ()=>setResendIn({
                        "VerifyOTPPage.useEffect.t": (v)=>v > 0 ? v - 1 : 0
                    }["VerifyOTPPage.useEffect.t"])
            }["VerifyOTPPage.useEffect.t"], 1000);
            return ({
                "VerifyOTPPage.useEffect": ()=>clearInterval(t)
            })["VerifyOTPPage.useEffect"];
        }
    }["VerifyOTPPage.useEffect"], [
        resendIn
    ...
    const code = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VerifyOTPPage.useMemo[code]": ()=>otp.join('')
    }["VerifyOTPPage.useMemo[code]"], [
        otp
    ]);
    ...
    const onSubmit = async (e)=>{
        ...
        setInfo(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].verifyOTP({
                email,
                otpCode: code
    ...
    const onResend = async ()=>{
        ...
        setInfo(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].requestOTP({
                email
            });
...
_s(VerifyOTPPage, "+dxOMkR7F642vSuxmOgk9dMyHaE=", false, function() {
    return [
...
//# sourceMappingURL=src_56361584._.js.map
...
const plans: Plan[] = [
  {
    ...
    price: 20,
    period: '/mo',
    tagline: '28 global currency pairs with real-time analytics',
    icon: DollarSign,
    features: [
      'Real-time forex heatmaps & strength meters',
      '28 currency pairs (majors, minors, INR crosses)',
  ...
  },
  {
    ...
    features: [
      ...
      'AI dual-agent signal pipeline',
      'Algo playground with circuit breakers',

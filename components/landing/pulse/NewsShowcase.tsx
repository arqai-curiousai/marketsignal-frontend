        ...
        <div className="grid grid-cols-1 md:grid-cols-[45%_55%] gap-8 md:gap-12 items-center">
          ...
          >
            <div className="aspect-[16/10]">
              <VideoClip
                webm={PULSE_NEWS_SHOWCASE.video.webm}
                mp4={PULSE_NEWS_SHOWCASE.video.mp4}
                overlay={false}
                opacity={1}
              />
            </div>

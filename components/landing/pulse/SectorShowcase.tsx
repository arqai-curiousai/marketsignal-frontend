        ...
        <div className="grid grid-cols-1 md:grid-cols-[45%_55%] gap-8 md:gap-12 items-center">
          ...
          >
            <div className="aspect-[16/10]">
              <VideoClip
                webm={PULSE_SECTOR_SHOWCASE.video.webm}
                mp4={PULSE_SECTOR_SHOWCASE.video.mp4}
                overlay={false}
                opacity={1}
              />
            </div>
            <div
              ...
              style={{ boxShadow: 'inset 0 0 80px rgba(110,231,183,0.06)' }}
            />
          </motion.div>
        </div>
      </div>

        ...
        <div className="grid grid-cols-1 md:grid-cols-[55%_45%] gap-8 md:gap-12 items-center">
          ...
          >
            <div className="aspect-[16/10]">
              <VideoClip
                webm={FOREX_STRENGTH_SHOWCASE.video.webm}
                mp4={FOREX_STRENGTH_SHOWCASE.video.mp4}
                overlay={false}
                opacity={1}
              />
            </div>
